...
import {useOAuthCredentials} from './hooks/useOAuthCredentials/useOAuthCredentials';
...
const App = ({filters, addTimeEntries, addProjects, addTasks}: AppProps) => {
    const isOAuthCredentials = useOAuthCredentials();
    ...
    return (
        <>
            <nav className={styles['app-navbar']}>
                <h1 className={styles['app-title']}>Harvest V2 API Client</h1>
            </nav>
